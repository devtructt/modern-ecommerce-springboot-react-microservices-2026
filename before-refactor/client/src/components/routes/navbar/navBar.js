...
/*     useEffect(() => {
        ...
        if (isSignedIn === null) {
            // if user is not signed in then signed it in using account details from the cookie.
    ...
    return (
        <>
            <SideBar open={true} closeHandler={handleSidebarClose} />
