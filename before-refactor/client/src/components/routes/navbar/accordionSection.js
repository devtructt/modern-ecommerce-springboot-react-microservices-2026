                        ...
                        <Grid container direction="column" style={{paddingLeft: "0.5rem"}}>
                            <Grid item>
                                {renderNestedAccordion("Top Brands",
                                    tabsAPIData?.data?.[conf.mapKey]?.brands || [{ id: 1, value: "A" }, { id: 2, value: "B" }, { id: 3, value: "C" }],
                                    `${conf.mapKey}-brands-`,"brands")}
                            </Grid>
                            <Grid item>
                                {renderNestedAccordion("Top Categories",
                                    tabsAPIData?.data?.[conf.mapKey]?.apparels || [{ id: 1, value: "X" }, { id: 2, value: "Y" }, { id: 3, value: "Z" }],
